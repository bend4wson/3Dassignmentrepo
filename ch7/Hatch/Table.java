...
public class Table {
  ...
  private TransformNode translateX, tableMoveTranslate
  ...
  public Robot(GL3 gl, Camera camera, Light light, int[] textureId1, int[] textureId2,int[] textureId3,
    ...
    float tableTopHeight = 3f;
    float tableTopDimension = 2f;
    float tableTopDepth = 0.5f;
    float tableLegLength = 2f;
    ...
    //TransformNode tableTranslate = new TransformNode("table transform",Mat4Transform.translate(0,tableLegLength,0));
