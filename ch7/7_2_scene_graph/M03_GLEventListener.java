...
public class M03_GLEventListener implements GLEventListener {
  ...
  private void initialise(GL3 gl) {
    ...
    m = Mat4.multiply(m, Mat4Transform.translate(0,0.5f,0));
    TransformNode makeUpperBranch = new TransformNode("scale(0.9f,2.6f,0.9f);translate(0,0.5,0)", m);
    ModelNode cube1Node = new ModelNode("Sphere(1)", sphere);
        
    branchRoot.addChild(translateX);
      translateX.addChild(rotateAll);
        rotateAll.addChild(branch);
    ...
    branchRoot.update();  // IMPORTANT – must be done every time any part of the scene graph changes
